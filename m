...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1D950394697
	for <lists+linux-fpga@lfdr.de>; Fri, 28 May 2021 19:40:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229453AbhE1RmB (ORCPT <rfc822;lists+linux-fpga@lfdr.de>);
        Fri, 28 May 2021 13:42:01 -0400
Received: from mga14.intel.com ([192.55.52.115]:15937 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229450AbhE1RmA (ORCPT <rfc822;linux-fpga@vger.kernel.org>);
        Fri, 28 May 2021 13:42:00 -0400
IronPort-SDR: oIVCearOiFXbNUSnpOWhmf6w042JDiPMSE0l0ocIgcfKLEpSviqdI0/5EP5yQvEiLsnD1YDL1+
 gdha6IgKcvcQ==
X-IronPort-AV: E=McAfee;i="6200,9189,9998"; a="202772678"
X-IronPort-AV: E=Sophos;i="5.83,230,1616482800"; 
   d="scan'208";a="202772678"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 May 2021 10:40:25 -0700
IronPort-SDR: e3xRf5fjuw1NyQGcpe/71jg0AOaH5Oez69t+o/i7jm81u3YPXI2HA/0+mQU4nb6/LBswtbzUsv
 zMxea+jWKsTw==
X-IronPort-AV: E=Sophos;i="5.83,230,1616482800"; 
   d="scan'208";a="548663349"
Received: from rhweight-mobl2.amr.corp.intel.com (HELO [10.0.2.4]) ([10.209.50.238])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 May 2021 10:40:25 -0700
...
References: <20210524185049.681683-1-russell.h.weight@intel.com>
 ...
 <20210528154108.GA1881814@yilunxu-OptiPlex-7050>
From:   Russ Weight <russell.h.weight@intel.com>
Message-ID: <450d3a4d-53f3-9756-54b2-92dc0f3d0116@intel.com>
Date:   Fri, 28 May 2021 10:26:42 -0700
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.7.1
MIME-Version: 1.0
In-Reply-To: <20210528154108.GA1881814@yilunxu-OptiPlex-7050>
...
On 5/28/21 8:41 AM, Xu Yilun wrote:
...
> It seems problematic the compat_id is set after the registration of fpga_mgr,
> although I didn't found its usage in fpga-mgr.c.
>
> But there is also a compat_id for fpga-region class, which will be shown
> to user via sysfs. In that case, it may be a real problem.
>
> How about we add the compat_id param for fpga_mgr/region_register()?

Yes, I think you are right. I'll make the suggested changes.
...
> Any reason we change the format of the Return description?

I was focusing on the change to the return value and didn't pay attention to
the format. I'll change the format back.
