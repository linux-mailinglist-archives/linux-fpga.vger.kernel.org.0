...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5572341548B
	for <lists+linux-fpga@lfdr.de>; Thu, 23 Sep 2021 02:18:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238687AbhIWAT6 (ORCPT <rfc822;lists+linux-fpga@lfdr.de>);
        Wed, 22 Sep 2021 20:19:58 -0400
Received: from mga09.intel.com ([134.134.136.24]:8311 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S238643AbhIWAT5 (ORCPT <rfc822;linux-fpga@vger.kernel.org>);
        Wed, 22 Sep 2021 20:19:57 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10115"; a="223763489"
X-IronPort-AV: E=Sophos;i="5.85,315,1624345200"; 
   d="scan'208";a="223763489"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Sep 2021 17:18:26 -0700
X-IronPort-AV: E=Sophos;i="5.85,315,1624345200"; 
   d="scan'208";a="474688912"
Received: from rhweight-mobl2.amr.corp.intel.com (HELO rhweight-mobl2.ra.intel.com) ([10.209.87.52])
  by orsmga007-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Sep 2021 17:18:25 -0700
...
Subject: [PATCH v15 4/4] fpga: m10bmc-sec: add max10 secure update functions
Date:   Wed, 22 Sep 2021 17:18:22 -0700
Message-Id: <20210923001822.283220-5-russell.h.weight@intel.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20210923001822.283220-1-russell.h.weight@intel.com>
References: <20210923001822.283220-1-russell.h.weight@intel.com>
MIME-Version: 1.0
...
v2:
  ...
  - Moved MAX10 BMC address and function definitions to a separate
    patch.
---
 drivers/fpga/intel-m10-bmc-sec-update.c | 303 +++++++++++++++++++++++-
 1 file changed, 302 insertions(+), 1 deletion(-)

diff --git a/drivers/fpga/intel-m10-bmc-sec-update.c b/drivers/fpga/intel-m10-bmc-sec-update.c
index bccffc62a747..e9fa5dfebed8 100644
--- a/drivers/fpga/intel-m10-bmc-sec-update.c
+++ b/drivers/fpga/intel-m10-bmc-sec-update.c
@@ -181,7 +181,299 @@ static const struct attribute_group *m10bmc_sec_attr_groups[] = {
 	NULL,
 };
...
+}
+
+static u32 m10bmc_sec_prepare(struct fpga_image_load *imgld)
+{
...
+}
+
+static u32 m10bmc_sec_write_blk(struct fpga_image_load *imgld, u32 offset,
...
+}
+
+static u32 m10bmc_sec_cancel(struct fpga_image_load *imgld)
+{
+	struct m10bmc_sec *sec = imgld->priv;
+	u32 doorbell;
+	int ret;
